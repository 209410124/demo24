let tours_24 = [
  ...
  { id:3,
    ...
    info:'Lets go where classical music, towering castles, and the-hills-are-alive scenery welcome you to the gemütlichkeit of Bavaria and opulence of Austria s Golden Age. Your Rick Steves guide will bring th...',
...
const displayTours_24 = () => {
  const toursInfo =tours_24.map((tour)=>{
